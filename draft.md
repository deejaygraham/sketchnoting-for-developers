				...
				<section>
					<blockquote>
						&ldquo;Learning is not compulsory; it's voluntary. 
						Improvement is not compulsory; it's voluntary. 
						But to survive, we must learn.&rdquo;
					</blockquote>
					<p style="color: #3D424F">W. Edwards Deming</p>
				</section>
				...
				*	
				...
				<section data-background="./images/dave-gray-mann-gruber.jpg" >
				</section>
				
				<section data-background="./images/josie-long-another-planet.jpg" >
				</section>
				
				<!-- xkcd -->				
				<section data-background="./images/xkcd-whatif-tie-coin-toss.png" data-background-size="contain" >
				</section>

				
				<section data-background="./images/tom-gauld-sketchbook-1.jpg" >
					Michael Angelo?
					> Picasso
					> Tom Gauld
					> Modern Toss?
				...
				<!-- Equipment -->
				<section>
					Equipment - pens, books, lofi - brown paper bags.
				...
				<section>
					Follow the speaker
					<!-- body language, voice - not the slides available online after talk -->
				</section>

				<section>
					Don't boil the ocean
					<!-- what would you use 10 tweets to tweet about ? -->
				</section>
				...
				<section>
					...
					boxes and arrows to give emphasis'
				</section>
				...
				<section>
					Share with speaker, twitter or flickr
				</section>

				<section>
					Unit Tests
					<!-- really only matters to you - can you reconstruct talk from the pictures -->
...
<section>
				...
				<section>
				Jokes, quotes f-bombs - high emotion or excitement, dramatic pauses, metaphors and similies	
				</section>
...
Learning and Visual Notetaking
...
Education
Brad Ovenell-Carter - research in schools for academic sketchnoting
Julie Stitt
...
Inspiration
	...
	Steal techniques - how someone writes 
	Sketchnote army
	icon website
